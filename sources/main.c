...
int main(void)
{
    ...
    enemy_texture = LoadTexture(ASSETS_PATH"Rayan.png");
    ...
    while (!WindowShouldClose())
    {
        ...
        //Rendering
        {
            ...
            if (!enemy_alive)
            {
                Vector2 text_dimensions = MeasureTextEx(GetFontDefault(), "YOUR WINNER!", 30, 2);
                Vector2 screen_position = (Vector2){
                    .x = (SCREEN_WIDTH / 2) - (text_dimensions.x / 2),
                    .y = (SCREEN_HEIGHT/2) - (text_dimensions.y/2)
                };

                DrawText("YOUR WINNER!", screen_position.x, screen_position.y, 30, WHITE);
            }
            ...
            if (player_lives <= 0)
            {
                Vector2 text_dimensions = MeasureTextEx(GetFontDefault(), "BOZO", 30, 2);
                Vector2 screen_position = (Vector2){
                    .x = (SCREEN_WIDTH / 2) - (text_dimensions.x / 2),
                    .y = (SCREEN_HEIGHT / 2) - (text_dimensions.y / 2)
                };

                DrawText("BOZO", screen_position.x, screen_position.y, 30, WHITE);
            }
